...
def pier_6_figs():
    ...
    make_categorical_figure(proj_name, landscape_only_as_designed, HTML)
    ...
    make_stack_compare_figure(
        proj_name, as_designed, worse_alt, renderer=HTML, filter_categories=[UseCategories.SUBSTRUCTURE, UseCategories.HARDSCAPE]
    )
    ...
    #         landscape_only_worse, # no salvage.. 
    #         renderer=HTML,
    #         filter_categories=[UseCategories.HARDSCAPE], # ABSENCE OF SALVAGE MATERIAL SHOULD MAKE OVERALL HARDSCAPE NUMBER GO WAY UP.. 
    #         # filter_elements=["Salvaged"],
    #     )
    ...
    make_dot_comparison_figure(proj_name, as_designed, worse_alt, renderer=HTML)
...
def saginaw_figs():
    ...
    make_stack_compare_figure(
        proj_name, as_designed, worse_alt, HTML, filter_categories=[]
    )
